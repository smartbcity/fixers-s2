...
import s2.spring.storming.S2StormingSpringDataAdapter

@Configuration
class OrderBookAutomateConfig : S2StormingSpringDataAdapter<
		OrderBookState, OrderBookId, OrderBook, OrderBookEvent, OrderBookS2Aggregate>() {
...
@Service
class OrderBookS2Aggregate : S2AutomateEvolverSpring<OrderBookState, OrderBookId, OrderBook, OrderBookEvent>()
